...
var customDateDDMMMYYYYToOrd = function (date) {
	...
	return (dateParts[2].split(' ')[0] * 10000) + ($.inArray(dateParts[1].toUpperCase(), ["JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC"]) * 100) + (dateParts[0] * 1) + dateParts[2].split(' ')[1].replace(":", "");   //Changes Done By Nikhil Shetye (dateParts[2] * 10000) 
};
